define('router/handler-info', ['exports', './utils', 'rsvp/promise'], function (exports, utils, Promise) {
  ...
  HandlerInfo.prototype = {
    ...
    resolve: function(shouldContinue, payload) {
      ...
      return Promise['default'].resolve(undefined, this.promiseLabel("Start handler"))
    ...
    runSharedModelHook: function(payload, hookName, args) {
      ...
      return Promise['default'].resolve(result, this.promiseLabel("Resolve value returned from one of the model hooks"));
    },
    ...
    checkForAbort: function(shouldContinue, promiseValue) {
      return Promise['default'].resolve(shouldContinue(), this.promiseLabel("Check for abort")).then(function() {
...
define('router/handler-info/resolved-handler-info', ['exports', '../handler-info', 'router/utils', 'rsvp/promise'], function (exports, HandlerInfo, utils, Promise) {
...
define('router/handler-info/unresolved-handler-info-by-object', ['exports', '../handler-info', 'router/utils', 'rsvp/promise'], function (exports, HandlerInfo, utils, Promise) {
...
define('router/handler-info/unresolved-handler-info-by-param', ['exports', '../handler-info', 'router/utils'], function (exports, HandlerInfo, utils) {
...
define('router/router', ['exports', 'route-recognizer', 'rsvp/promise', './utils', './transition-state', './transition', './transition-intent/named-transition-intent', './transition-intent/url-transition-intent', './handler-info'], function (exports, RouteRecognizer, Promise, utils, TransitionState, transition, NamedTransitionIntent, URLTransitionIntent, handler_info) {

  'use strict';

  var pop = Array.prototype.pop;
  // "transition" is used as a paramater name and TransitionAborted, logAbort lose scope
  var TA = transition.TransitionAborted;
  var logA = transition.logAbort;
  function Router() {
  ...
  function finalizeTransition(transition, newState) {
    ...
    try {
      ...
      if (transition.isAborted) {
        ...
        return Promise['default'].reject(transition.logAbort(transition));
      }
...
define('router/transition-intent', ['exports', './utils'], function (exports, utils) {
...
define('router/transition-intent/named-transition-intent', ['exports', '../transition-intent', '../transition-state', '../handler-info/factory', '../utils'], function (exports, TransitionIntent, TransitionState, handlerInfoFactory, utils) {
...
define('router/transition-intent/url-transition-intent', ['exports', '../transition-intent', '../transition-state', '../handler-info/factory', '../utils'], function (exports, TransitionIntent, TransitionState, handlerInfoFactory, utils) {
...
define('router/transition-state', ['exports', './handler-info', './utils', 'rsvp/promise'], function (exports, handler_info, utils, Promise) {
  ...
  TransitionState.prototype = {
    ...
    resolve: function(shouldContinue, payload) {
      ...
      return Promise['default'].resolve(null, this.promiseLabel("Start transition"))
      .then(resolveOneHandlerInfo, null, this.promiseLabel('Resolve handler'))['catch'](handleError, this.promiseLabel('Handle error'));

      function innerShouldContinue() {
        return Promise['default'].resolve(shouldContinue(), currentState.promiseLabel("Check if should continue"))['catch'](function(reason) {
          // We distinguish between errors that occurred
          // during resolution (e.g. beforeModel/model/afterModel),
          // and aborts due to a rejecting promise from shouldContinue().
          wasAborted = true;
          return Promise['default'].reject(reason);
...
define('router/transition', ['exports', 'rsvp/promise', './handler-info', './utils'], function (exports, Promise, handler_info, utils) {
  ...
  function Transition(router, intent, state, error) {
    ...
    if (error) {
      this.promise = Promise['default'].reject(error);
      this.error = error;
      return;
    }
    ...
    if (state) {
      ...
      this.promise = state.resolve(checkForAbort, this)['catch'](function(result) {
        if (result.wasAborted || transition.isAborted) {
          return Promise['default'].reject(logAbort(transition));
        } else {
          transition.trigger('error', result.error, transition, result.handlerWithError);
          transition.abort();
          return Promise['default'].reject(result.error);
        }
      }, utils.promiseLabel('Handle Abort'));
    } else {
      this.promise = Promise['default'].resolve(this.state);
      this.params = {};
    }

    function checkForAbort() {
      if (transition.isAborted) {
        return Promise['default'].reject(undefined, utils.promiseLabel("Transition aborted - reject"));
      }
    }
  }
